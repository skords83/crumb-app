      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-[2rem] shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 transition-colors duration-200">
        ...
        <div className="relative h-80 overflow-hidden">
          <img
            ...
            alt={recipe.title}
          />
          <div className="absolute inset-0 bg-gradient-to-t from-white dark:from-gray-800 from-[15%] via-white/0 dark:via-gray-800/0 via-[60%] to-black/15 pointer-events-none" />
